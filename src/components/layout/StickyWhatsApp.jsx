...
const StickyWhatsApp = ({ settings }) => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-surface px-4 py-2 rounded-lg text-primary text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">Chat WhatsApp Sekarang</span>
    </a>
  );
};

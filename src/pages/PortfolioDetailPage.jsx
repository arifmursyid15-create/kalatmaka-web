    ...
    <main className="pb-section-gap">
      <section className="relative min-h-[560px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto w-full pb-16 text-white">
          <Link className="font-label-sm uppercase tracking-widest text-white/80 hover:text-white" to="/portfolio">Back to Portfolio</Link>
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto py-20 grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-7">
          <span className="text-primary font-label-sm tracking-widest uppercase mb-4 block">Project Story</span>
          <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">{project.description || 'A Kalatmaka interior project shaped around thoughtful materials, precise detailing, and a calm everyday experience.'}</p>
        </div>
        <aside className="lg:col-span-5 bg-surface-container-low rounded-3xl p-8 h-fit">
          <h2 className="font-headline-md text-headline-md text-on-surface mb-6">Project Details</h2>
          <dl className="space-y-5">
            <div>
              <dt className="font-label-sm text-on-surface-variant uppercase tracking-widest">Location</dt>
              <dd className="font-body-lg text-on-surface mt-1">{project.location || 'Indonesia'}</dd>
            </div>
            <div>
              <dt className="font-label-sm text-on-surface-variant uppercase tracking-widest">Scope</dt>
              <dd className="font-body-lg text-on-surface mt-1">Interior design, material selection, styling</dd>
            </div>
          </dl>
        </aside>
      </section>
